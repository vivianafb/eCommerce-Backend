...
class ProductosFSDAO {
  ...
  async leer(archivo) {
    this.productos = JSON.parse(await _fs.default.promises.readFile(archivo, 'utf-8'));
  }

  async guardar() {
    await _fs.default.promises.writeFile(this.nombreArchivo, JSON.stringify(this.productos, null, '\t'));
  }
